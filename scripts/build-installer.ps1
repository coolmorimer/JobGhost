...
$jobghostSpeechCache=Join-Path $jobghostRoot '.jobghost\models\models--Systran--faster-whisper-small\snapshots'
...
if(-not $jobghostSpeechSnapshot){throw 'Модель Whisper small не найдена. Запустите JobGhost один раз и дождитесь статуса речи «Готово».'}

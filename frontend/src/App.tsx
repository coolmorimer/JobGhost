...
const nav=[['Interviews','Помощник',Mic2],['Preparation','Подготовка и тренировка',BriefcaseBusiness],['Dashboard','Обзор',LayoutDashboard],['Vacancies','Вакансии',Building2],['Applications','Отклики и письма',BriefcaseBusiness],['Profile','Мой профиль',CircleUserRound],['Settings','Настройки и помощь',Settings]] as const;
